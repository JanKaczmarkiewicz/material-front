...
export interface ChangeAssignedStreets_updateDay_unusedHouses_street {
  id: string;
  name: string;
}

export interface ChangeAssignedStreets_updateDay_unusedHouses {
  id: string;
  number: string;
  street: ChangeAssignedStreets_updateDay_unusedHouses_street | null;
}
...
export interface ChangeAssignedStreets_updateDay {
  ...
  unusedHouses: ChangeAssignedStreets_updateDay_unusedHouses[];
